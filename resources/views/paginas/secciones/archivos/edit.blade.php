...
@section('title_page', 'Editar archivo de la sección')
...
<div class="card-body">
    <form action="{{ route('paginas.seccion-archivos-update', [$pagina, $paginaSeccion, $paginaSeccionArchivo]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="">
            <div class="row">
                <div class="col-sm">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="titulo" value="{{ old('titulo', $paginaSeccionArchivo->titulo) }}"
                            autocomplete="off">
                        @error('titulo')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" name="archivo" value="{{ old('archivo') }}"
                            ...
                            @else
                                ...
                                @switch($paginaSeccionArchivo->tipo)
                                    @case('pdf')
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>                                                                
                                                                <small><a href="{{asset('storage').'/'.$paginaSeccionArchivo->archivo}}" target="_blank">{{$paginaSeccionArchivo->titulo}}</a></small>
                                                            </p>
                                                            <iframe src="{{asset('storage').'/'.$paginaSeccionArchivo->archivo}}" frameborder="0" width="100%"></iframe>
                                                        </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <img src="{{asset('storage').'/'.$paginaSeccionArchivo->archivo}}" alt="archivo-{{$paginaSeccionArchivo->titulo}}"
            ...
            <div class="row">
                <div class="col-sm">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="enlace" value="{{ old('enlace', $paginaSeccionArchivo->enlace) }}"
                            autocomplete="off">
                        @error('enlace')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                ...
                <div class="col-sm">
                    <div class="mb-3 w-50">
                        ...
                        <select class="form-select" name="estado" required>
                            ...
                            <option {{ old('estado') == 'Si' ? 'selected' : ($paginaSeccionArchivo->estado == 'Si' ? 'selected' : '') }} value="Si">Si</option>
                            <option {{ old('estado') == 'No' ? 'selected' : ($paginaSeccionArchivo->estado == 'No' ? 'selected' : '') }} value="No">No</option>
                        </select>
                        @error('estado')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                ...
                <input type="hidden" name="seccion_id" value="{{$paginaSeccionArchivo->seccion_id}}">
            </div>
        </div>
        <br>

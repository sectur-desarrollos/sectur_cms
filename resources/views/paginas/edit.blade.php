...
@section('title_page', 'Editar página')
...
<div class="card shadow p-3 mb-5 bg-body rounded">
    <div class="container">
        ...
        <div class="d-flex justify-content-between">
            ...
            <a href="{{route('pagina', $pagina->slug)}}" class="btn btn-info btn-sm" target="_blank">Ver página</a>
        </div>
        {!! Form::model($pagina, ['route' => ['paginas.update', $pagina], 'autocomplete' => 'off', 'files' => true, 'method' => 'PUT']) !!}
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            {!! Form::text('slug', $pagina->slug, ['class' => 'form-control', 'readonly' => 'true' ]) !!}
            @error('titulo')
            <small class="text-danger">{{$message}}</small>
            @enderror
        </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="image-wrapper">
                        @if (is_null($pagina->imagen_destacada))
                            <small>Vista prevía de la imagen destacada.</small>
                            <img id="image_preview" src="" alt="imagen">
                        @else
                            <small>Vista prevía de la imagen destacada.</small>
                            <img id="image_preview" src="{{asset('storage').'/'.$pagina->imagen_destacada}}" alt="imagen" class="img-fluid rounded mx-auto d-block">
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="mb-3">
            ...
            {!! Form::text('fuente', $pagina->fuente, ['class' => 'form-control' ]) !!}
            @error('fuente')
            <small class="text-danger">{{$message}}</small>
            @enderror
        </div>
	    ...
	    {!! Form::datetimeLocal('updated_at', \Carbon\Carbon::parse($pagina->updated_at)->format('Y-m-d\TH:i'), ['class' => 'form-control']) !!}
	    @error('updated_at')
            <small class="text-danger">{{$message}}</small>
	    @enderror
	</div>

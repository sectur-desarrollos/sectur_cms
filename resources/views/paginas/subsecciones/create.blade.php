...
@section('title_page', 'Crear nueva subsección')
...
<div class="card-body">
    <form action="{{ route('paginas.pagina-subseccion-store', [$pagina, $paginaSeccion]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="">
            <div class="row">
                <div class="col-sm">

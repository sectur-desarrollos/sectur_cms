...
@section('title_page', 'Crear contenido footer')
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                {{-- <input  type="text" class="form-control" name="tipo" value="{{ old('tipo') }}" autocomplete="off"> --}}
                                <select class="form-select w-50" name="tipo">
                                    <option value="" selected>Seleccionar tipo</option>
                                    <option {{ old('tipo') == '1' ? 'selected' : '' }} value="1">Contacto</option>
                                    <option {{ old('tipo') == '2' ? 'selected' : '' }} value="2">Recursos del Portal</option>
                                </select>
                                @error('tipo')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input  type="text" class="form-control" name="valor" value="{{ old('valor') }}" autocomplete="off">
                                @error('valor')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input  type="text" class="form-control" name="enlace" value="{{ old('enlace') }}" autocomplete="off">
                                @error('enlace')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>

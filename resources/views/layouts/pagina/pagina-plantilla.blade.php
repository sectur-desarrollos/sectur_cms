            ...
            <div class="row">
                <div class="col offset-1">
                    <div class="col">
                        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3  bg-dark" href="#"><img
                                class="img-fluid bg-dark" src="{{asset('assets/imgs/sectur/logo_sectur.png')}}"
                                alt="logo_sectur"></a>
                    </div>
                    <div class="col">
                        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 bg-dark" href="#"><img
                ...
                <div class="col float-sm-start">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted text-white">Conócenos</a>
                        </li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted text-white">Directorio
                                de
                                funcionarios</a></li>
                ...
                <div class="col float-sm-start">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted text-white">Boletines
                                informativos</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted text-white">Contacto
                                Limpio
                                Chiapas</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted text-white">Quejas
                                e incorfomidades</a>
                        </li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted text-white">Contacto</a>
                        </li>
                    </ul>
                </div>
                <div class="col float-sm-start">

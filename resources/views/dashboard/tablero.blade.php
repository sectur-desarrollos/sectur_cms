...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        @unlessrole('Admin')
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('paginas.paginas-empleados')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-minus" viewBox="0 0 16 16">
                                    <path d="M5.5 8a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1H6a.5.5 0 0 1-.5-.5z"/>
                                    <path d="M4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H4zm0 1h8a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"/>
                                </svg>
                        ...
                        @role('Admin')
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('repositorios.index')}}">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container">
                    <h5 class="text-secondary">Bienvenido {{Auth::user()->name}}.</h5>
                    <br>
                    <div class="row">
                        @role('Admin')
                        <div class="col-sm">
                        ...
                        <div class="col-sm">
                            <div class="card  shadow p-3 mb-5 bg-body rounded" style="width: 18rem;">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('users.index')}}" class="btn btn-primary btn-sm">Ir...</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm">
                        ...
                        <div class="col-sm">
                            <div class="card  shadow p-3 mb-5 bg-body rounded" style="width: 18rem;">
                                <div class="card-body">
                                    <h5 class="card-title">Páginas asignadas</h5>
                                    <p class="card-text">Total de páginas: {{$paginasUsuarioAutenticado}}</p>
                                    <a href="{{route('paginas.paginas-empleados')}}" class="btn btn-primary btn-sm">Ir...</a>
                                </div>
                            </div>
                        </div>
                        @endunlessrole
    ...
    {{-- Eliminar valores guardados del Datatables en el localstorage para evitar errores de paginación --}}
    <script>
        function limpiarLocalStorage(dataTableName) {
            localStorage.removeItem(dataTableName);
        }

        // Limpia el localStorage para cada tabla DataTable
        limpiarLocalStorage('DataTables_paginasSeccionesTable');
        limpiarLocalStorage('DataTables_paginasArchivosTable');
        limpiarLocalStorage('DataTables_activityLogsTable');
        limpiarLocalStorage('DataTables_menuTable');
        limpiarLocalStorage('DataTables_paginasSubSeccionesTable');
        limpiarLocalStorage('DataTables_repositoriosTable');
        limpiarLocalStorage('DataTables_paginasSeccionArchivosTable');
        limpiarLocalStorage('DataTables_paginasSubSeccionArchivosTable');
        limpiarLocalStorage('DataTables_paginasTable');
    </script>
</body>

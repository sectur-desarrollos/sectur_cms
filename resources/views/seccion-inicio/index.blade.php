...
@section('title_page', 'Secciones Inicio')
    ...
    <div class="carrd-header">
        <div class="d-flex justify-content-between">
            ...
            @can('admin.users.create')
                <a href="{{route('seccion-inicio.create')}}" class="btn btn-primary btn-sm">Nueva sección</a>
            @endcan
        </div>
    </div>
    <div class="card-body">
        <table class="table" id="seccionTable">
            <thead>
                <tr>
                    {{-- <th>Nombre</th> --}}
                    <th>Identificador</th>
